/*
 * This DEMO code builds upon Sparkfun's code for Reading EPC's 
  https://github.com/sparkfun/Simultaneous_RFID_Tag_Reader
 * and shows you how you can take that EPC
 * and send the tag to another arduino via I2C
 * 
...
#include <SoftwareSerial.h> //Used for transmitting to the RFID device
...
// Include the required Wire library for I2C (for talking from one arduino to another)
#include <Wire.h>
...
runBasicMovement();
  ...
  delay(2000);                       // wait for  a bit between reads

}


void runBasicMovement(){
